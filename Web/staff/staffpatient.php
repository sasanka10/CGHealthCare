    ...
    <div class="row margin-bottom-40">
         <div class="panel panel-blue">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-tasks"></i>Create Patient</h3>
             </div>
             <div class="panel-body"> 
              <form action="" id="sky-form" class="sky-form">
                 <div class="col-md-12">  
                   ...
                   <button type="button" class="btn-u pull-right"  name="button" id="btnSubmitPatient">Save Data</button>
                    ...
                    <section class="col col-8">
                        <div class="col-md-15">
                          <div class="panel panel-sea margin-bottom-40">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-edit"></i>Patient Data</h3>
